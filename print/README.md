...
- Cards are poker-ish rectangles (`2.48" × 3.47"`) with a dashed cut line. Full card art prints uncropped (`contain`); rules sit on a panel over the lower part of the card.
- Landscapes print as the full square illustration (~`3.28"`). Cut the inner dashed pointy-top hex. Name/actions are under the art, not covering it. Print the Wasteland backs and glue or sleeve them to outer tiles. **The Bed** never flips; skip a back for it.
