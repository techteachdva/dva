...
# If the file already ends with the closing brace and colon, we need to append the missing code.
# The current broken file ends with "\t}:"
if not text.rstrip().endswith("\t}:"):
    print("File does not appear to be missing code. Exiting.")
    exit(0)
...
print("Reconstructed missing builder code in scripts/level_generator.gd")
