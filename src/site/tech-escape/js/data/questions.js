...
const DESIGN = [
  ...
  },
  {
    ...
    std: 'ITEM 8.3.3.1 - Design process | ISTE 1.1c Empowered Learner',
    level: 2,
  },
  {
    id: 'DES-007',
  ...
  },
  {
    ...
    std: 'ITEM 8.3.3.1 - Design process | ISTE 1.6d Creative Communicator',
    level: 2,
  },
  {
    id: 'DES-013',
...
const SYSTEMS = [
  {
    ...
    std: 'CSTA 2-NI-04 - Network protocols',
    level: 2,
  },
  {
    id: 'SYS-002',
  ...
  },
  {
    ...
    std: 'ITEM 8.3.2.1 - Select appropriate tools | CSTA 2-CS-02',
    level: 3,
  },
  {
    id: 'SYS-025',
  ...
  {
    id: 'SYS-032',
    q: 'Your team needs to share live edits on the same slideshow during class. The best tool choice is usually:',
    a: [
      'A cloud presentation app with real-time collaboration',
      'A printed handout that each person updates separately',
      'A private notebook only one person can open',
      'A calculator app with no sharing features',
    ],
    correct: [0],
    why: 'The task is simultaneous collaboration on one product. Pick the tool built for shared editing, not one that forces manual merging later.',
    std: 'ITEM 8.3.2.1 - Select appropriate tools | CSTA 2-CS-02',
    level: 1,
  },
  {
    id: 'SYS-033',
    q: 'You need to interview a guest speaker who lives in another state. Which technology fits the purpose best?',
    a: [
      'A video call so you can ask questions in real time',
      'A word processor with no sharing turned on',
      'A local spreadsheet saved only on your device',
      'A photo editor with filters and stickers',
    ],
    correct: [0],
    why: 'Communication across distance needs a tool designed for live conversation. Writing or editing tools do not replace that purpose.',
    std: 'ITEM 8.3.2.1 - Select appropriate tools | CSTA 2-CS-02',
    level: 1,
  },
  {
    id: 'SYS-034',
    q: 'You collected temperature readings for a month and need to show trends to classmates. The strongest choice is:',
    a: [
      'A spreadsheet or chart tool that plots change over time',
      'A drawing program with only freehand lines',
      'A plain text file with numbers separated by commas',
      'A social post with no graph attached',
    ],
    correct: [0],
    why: 'Trends over time are easier to see in a chart. Match the tool to whether you are communicating patterns, not just storing raw numbers.',
    std: 'ITEM 8.3.2.1 - Select appropriate tools | CSTA 2-CS-02',
    level: 2,
  },
  {
    id: 'SYS-035',
    q: 'A group is brainstorming ideas before building a prototype. Which tool supports that purpose best?',
    a: [
      'A shared digital whiteboard or document everyone can edit',
      'A single-user game with no export option',
      'A password manager for saving login codes',
      'A system settings panel on one laptop',
    ],
    correct: [0],
    why: 'Brainstorming needs quick capture and visibility for the whole team. Choose collaboration features that match how the group will work together.',
    std: 'ITEM 8.3.2.1 - Select appropriate tools | CSTA 2-CS-02',
    level: 2,
  },
];
...
const DATA = [
  ...
  {
    id: 'DAT-044',
    q: 'You are researching whether your city should ban plastic bags. Which approach best follows research practice for multiple perspectives?',
    a: [
      'Find sources that argue for the ban and sources that argue against it',
      'Use only articles that match what you already believe',
      'Pick whichever result appears first in a search engine',
      'Cite one blog post because it summarizes the whole issue',
    ],
    correct: [0],
    why: 'Strong research on a debated issue needs sources from more than one side. A single viewpoint cannot show the full picture.',
    std: 'ITEM 8.1.2.3 - Sources with multiple perspectives | ISTE 1.3b Knowledge Constructor',
    level: 2,
  },
  {
    id: 'DAT-045',
    q: 'A database article titled "Benefits of school uniforms" is useful, but incomplete for a fair report. Your next step should be:',
    a: [
      'Search for a source that presents concerns or arguments against uniforms',
      'Assume the first article is correct and stop searching',
      'Rewrite the title so it sounds more neutral',
      'Delete the article because it shows bias',
    ],
    correct: [0],
    why: 'One-sided sources answer only part of a question. Pairing viewpoints is how you identify what each side claims and where they disagree.',
    std: 'ITEM 8.1.2.3 - Sources with multiple perspectives | ISTE 1.3b Knowledge Constructor',
    level: 2,
  },
  {
    id: 'DAT-046',
    q: 'Which pair of sources would best help you understand both sides of a school phone-policy debate?',
    a: [
      'A student editorial for phones and a principal statement against phones',
      'Two identical posts copied from the same social account',
      'A dictionary definition of "phone" and a photo of a classroom',
      'A game review and a weather forecast from the same news site',
    ],
    correct: [0],
    why: 'Multiple perspectives means sources that represent different positions on the issue, not duplicate or unrelated material.',
    std: 'ITEM 8.1.2.3 - Sources with multiple perspectives | ISTE 1.3b Knowledge Constructor',
    level: 1,
  },
  {
    id: 'DAT-047',
    q: 'After you finish a research project, using the rubric to score your own work helps mainly because:',
    a: [
      'It shows specific places to improve before you turn it in',
      'It guarantees you will earn the highest score possible',
      'It replaces feedback from your teacher or peers',
      'It proves you did not need to revise anything',
    ],
    correct: [0],
    why: 'Self-evaluation against clear criteria turns a finished draft into a plan for revision. Rubrics name what strong work looks like.',
    std: 'ITEM 8.1.5.2 - Reflect on research process | ISTE 1.3c Knowledge Constructor',
    level: 2,
  },
  {
    id: 'DAT-048',
    q: 'A peer reviewer says your conclusion does not match your evidence. The most useful response is to:',
    a: [
      'Recheck your sources and revise the conclusion or the evidence',
      'Ignore the comment because you already finished',
      'Change the font so the paper looks more professional',
      'Add more sources without reading whether they support your claim',
    ],
    correct: [0],
    why: 'Peer feedback is part of reflecting on research quality. The goal is to test whether your findings actually support what you claim.',
    std: 'ITEM 8.1.5.2 - Reflect on research process | ISTE 1.3c Knowledge Constructor',
    level: 2,
  },
  {
    id: 'DAT-049',
    q: 'When your research is done, asking "What question should I investigate next?" is valuable because:',
    a: [
      'Good research often opens new questions instead of closing inquiry',
      'Teachers require extra questions even when none exist',
      'It lets you avoid editing your current draft',
      'It means your first topic choice was a mistake',
    ],
    correct: [0],
    why: 'Reflection includes noticing gaps and follow-ups. The best projects point to what still needs to be learned.',
    std: 'ITEM 8.1.5.2 - Reflect on research process | ISTE 1.3c Knowledge Constructor',
    level: 3,
  },
];
