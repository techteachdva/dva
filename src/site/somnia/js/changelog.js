...
export const CHANGELOG = [
  ...
  },
  {
    ...
    notes: [
      "Every dream now carries a Game ID — the first Landscape revealed plus the dream's seed (like ENDLESS-OCEAN-7Q2M). Enter it on the menu and the exact same dream deals itself again: same board, same hands, same Mindstreams.",
