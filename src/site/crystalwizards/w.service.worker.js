...
/** @type {string} */
const CACHE_VERSION = '1771301843|9148985087';
/** @type {string} */
const CACHE_PREFIX = 'Crystal Wizards-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'w.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["w.html","w.js","w.offline.html","w.icon.png","w.apple-touch-icon.png","w.audio.worklet.js","w.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["w.wasm","w.pck"];
