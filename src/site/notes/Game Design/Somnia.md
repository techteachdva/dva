...
Live rules match Somnia **v 21.0** (`src/site/somnia/js/guide.js`). Play on the site or itch.io — same build. Add to Home Screen from the hosted table. Click a Dreamer on the board for phase actions.
